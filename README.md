...
<p align="center">
  <a href="https://huggingface.co/spaces/Sher29/content-agent">
    <img src="https://img.shields.io/badge/Live_Demo-HuggingFace-yellow?logo=huggingface&logoColor=white" />
  </a>
  <a href="https://sher29-content-agent-api.hf.space/docs">
    <img src="https://img.shields.io/badge/API_Docs-Swagger-green?logo=fastapi&logoColor=white" />
  </a>
...
- **Invalid input detection** — unrecognisable titles caught via enrichment confidence threshold, not brittle regex rules.
...
| Deployment | Docker + HuggingFace Spaces | Free, permanent, no cold starts |
...
The project is deployed as two HuggingFace Spaces:

| Service | URL |
|---|---|
| UI (Streamlit) | [huggingface.co/spaces/Sher29/content-agent](https://huggingface.co/spaces/Sher29/content-agent) |
| API (FastAPI) | [sher29-content-agent-api.hf.space/docs](https://sher29-content-agent-api.hf.space/docs) |

Both run on HuggingFace free tier — no credit card, no cold starts, permanently live.
...
```bash
curl -X POST https://sher29-content-agent-api.hf.space/analyse \
  -H "Content-Type: application/json" \
  -d '{"title": "Stranger Things", "synopsis": "Sci-fi horror set in 1980s Indiana."}'
```

Full interactive docs at `https://sher29-content-agent-api.hf.space/docs`.
...
| HuggingFace Spaces | Free — permanent, no cold starts |
